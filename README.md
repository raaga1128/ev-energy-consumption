...
Physics + ML ensemble modeling
Live traffic simulation
Battery SOC estimation
Highway EV route analysis

Designed as a research prototype for smart EV charging infrastructure and highway energy optimization.
...
****Machine Learning Inspired Prediction Engine****

***Physics-informed ensemble model using:***
1. Aerodynamic drag estimation
2. Rolling resistance
3. Traffic stop-go penalty
4. Li-ion thermal efficiency
...
1. Real-time charts
2. Battery SOC gauge
3. Energy factor breakdown
4. Charging station recommendations
5. Trip segment logging
...
IoT Sensors (MPU6050 + DHT11) -> ESP32 Controller -> Sensor Data Processing -> Physics + ML Prediction Engine -> EV Energy Consumption Dashboard -> Charging Recommendation System
...
to estimate EV energy consumption accurately.
...
4. Traffic Density Grid
5. EV Highway Visualization
6. ML Prediction Engine
7. Charging Recommendations
8. Battery SOC Monitoring

**Developed For
Track 3: EV Charging Infrastructure & Smart Energy Prediction
KL University — Research Prototype**
